...
<!-- Buttons for Starting Time-Slot -->
        ...
        <!-- Morning Slot -->
                <asp:Button runat="server" button_id="morning_start" OnClick="handle_starts"/>
                <asp:Button runat="server" button_id="morning_stop" OnClick="handle_stops" />
        <!-- Afternoon Slot -->
                <asp:Button runat="server" button_id="afternoon_start" OnClick="handle_starts" />
                <asp:Button runat="server" button_id="afternoon_stop" OnClick="handle_stops" />
        <!-- Evening Slot -->
                <asp:Button runat="server" button_id="evening_start" OnClick="handle_starts" />
                <asp:Button runat="server" button_id="evening_stop" OnClick="handle_stops" />

<!--Buttons for RESTOCK and DAY_END Actions-->

                <asp:Button runat="server" button_id="restock" OnClick="handle_restock" />
                <asp:Button runat="server" button_id="day_end" OnClick="handle_day_end" />
